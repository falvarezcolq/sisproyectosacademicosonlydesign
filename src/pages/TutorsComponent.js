...
class TutorsComponent extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <div className="container-fluid">
          ...
          <div className="row clearfix">
            ...
            <div class="card">
                        <div class="header">
                            <h2>
                                TUTORES DE LOS PROYECTOS (Tutor internos)
                                <small>400 Tutores, 5 doctores, 6 magister, 45 licenciados, 200 otros</small>
                                ...
                                <tbody>
                                  {this.state.tutors.map((item)=>(
                                    <tr>
                                      ...
                                      <td>{item.fullName}</td>
                                      <td>{item.finished}</td>
                                      <td>{item.on_develop}</td>
                                      <td>{item.not_concluded}</td>
                                      <td>{item.total}</td>
